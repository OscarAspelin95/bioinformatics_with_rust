...
## Alternatives
Even though bloom filters are common for fast lookups, there are several alternative data structures. One is the [cuckoo filter](https://en.wikipedia.org/wiki/Cuckoo_filter), which has a very nice Rust [implementation](https://docs.rs/scalable_cuckoo_filter/latest/scalable_cuckoo_filter/).
